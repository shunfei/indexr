...
public class PrefixComparators {
    ...
    public static final class StringPrefixComparator implements PrefixComparator {
        @Override
    ...
    public static final class StringPrefixComparatorDesc implements PrefixComparator {
        @Override
    ...
    public static final class BinaryPrefixComparator implements PrefixComparator {
        @Override
        public int compare(long aPrefix, long bPrefix) {
            return UnsignedLongs.compare(aPrefix, bPrefix);
        }
    ...
    public static final class BinaryPrefixComparatorDesc implements PrefixComparator {
        @Override
        public int compare(long bPrefix, long aPrefix) {
            return UnsignedLongs.compare(aPrefix, bPrefix);
        }
    ...
    public static final class LongPrefixComparator implements PrefixComparator {
        @Override
    ...
    public static final class LongPrefixComparatorDesc implements PrefixComparator {
        @Override
    ...
    public static final class DoublePrefixComparator implements PrefixComparator {
        @Override
        public int compare(long aPrefix, long bPrefix) {
    ...
    public static final class DoublePrefixComparatorDesc implements PrefixComparator {
        @Override
        public int compare(long bPrefix, long aPrefix) {
            double a = Double.longBitsToDouble(aPrefix);
            double b = Double.longBitsToDouble(bPrefix);
