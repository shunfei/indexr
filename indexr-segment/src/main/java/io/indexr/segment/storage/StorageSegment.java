...
public class StorageSegment<SC extends StorageColumn> implements Segment {
    ...
    protected ColumnNode[] columnNodes;
    protected List<SC> columns;

    long rowCount;

    public StorageSegment(int version, SegmentMode mode, String name, SegmentSchema schema, long rowCount, StorageColumnCreator<SC> scCreator) throws IOException {
