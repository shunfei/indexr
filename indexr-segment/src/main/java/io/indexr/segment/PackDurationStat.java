...
public class PackDurationStat {
    ...
    public void add_loadDPN(long time) {
        loadDPN.addAndGet(time);
    }

    public void add_loadIndex(long time) {
        loadIndex.addAndGet(time);
    }

    public void add_loadPack(long time) {
        loadPack.addAndGet(time);
    }

    public void add_compressPack(long time) {
        compressPack.addAndGet(time);
    }

    public void add_decompressPack(long time) {
