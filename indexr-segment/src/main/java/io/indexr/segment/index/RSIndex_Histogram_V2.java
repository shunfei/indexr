...
public class RSIndex_Histogram_V2 implements RSIndexNum {
    ...
    public static final Factory factory = new Factory() {
        ...
        public PackRSIndex createPack(byte dataType) {
            ...
            return new RSIndex_Histogram_V2.PackIndex(ColumnType.isFloatPoint(dataType));
        }

        @Override
        public RSIndex create(byte dataType, ByteSlice buffer, int packCount) {
            assert ColumnType.isNumber(dataType);
            return new RSIndex_Histogram_V2(buffer, packCount, ColumnType.isFloatPoint(dataType));
        }
    };
