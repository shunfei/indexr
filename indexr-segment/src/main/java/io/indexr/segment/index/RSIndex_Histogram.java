 ...
 */
public final class RSIndex_Histogram implements RSIndexNum {
    ...
    public static final Factory factory = new Factory() {
        ...
        public PackRSIndex createPack(byte dataType) {
            assert ColumnType.isNumber(dataType);
            return new PackIndex(ColumnType.isFloatPoint(dataType));
        }

        @Override
        public RSIndex create(byte dataType, ByteSlice buffer, int packCount) {
            assert ColumnType.isNumber(dataType);
            return new RSIndex_Histogram(buffer, packCount, ColumnType.isFloatPoint(dataType));
        }
    };
    ...
    public int write(ByteBufferWriter writer) throws IOException {
        ByteBuffer byteBuffer = histBuffer.toByteBuffer();
    ...
    public final static class PackIndex implements PackRSIndexNum {
        ...
        public void write(ByteBufferWriter writer) throws IOException {
            writer.write(histBuffer.toByteBuffer());
        }
