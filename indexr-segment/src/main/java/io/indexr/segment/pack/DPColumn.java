...
public class DPColumn extends StorageColumn {
    ...
    private boolean useExtIndex = true;
    ...
    void setUseExtIndex(boolean use) {
        this.useExtIndex = use;
    }
    ...
    private void setUpCache() throws IOException {
        if (packCount == 0) {
            ...
            if (lastDPN.objCount() == DataPack.MAX_COUNT) {
                ...
                dpnFileOffset = DataPackNode.serializedSize(version) * packCount;
                ...
                dpnFileOffset = DataPackNode.serializedSize(version) * (packCount - 1);
    ...
    private void saveCache() throws IOException {
        PackBundle p = cache.asPack(version, useExtIndex);
    ...
    private void savePack(DataPackNode dpn, DataPack pack, PackRSIndex index, PackExtIndex extIndex) throws IOException {
        ...
        dpnFileOffset += DataPackNode.serializedSize(version);
