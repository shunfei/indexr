...
String* Item_sum_int_rcbase::val_str(String*str)
{
	return NULL;
}
my_decimal* Item_sum_int_rcbase::val_decimal(my_decimal *)
{
	return NULL;
}

//TODO: Test this part
//void Item_sum_int_rcbase::int64_value(__int64 &value)
void Item_sum_int_rcbase::int64_value(_int64 &value)
{
	fixed = 1;
	count = value;
}
...
mysql_bool Item_sum_int_rcbase::add(){ return 0; }
void Item_sum_int_rcbase::update_field(){}


/************************************* Item_sum_sum_rcbase ************************************/

Item_sum_sum_rcbase::Item_sum_sum_rcbase() : Item_sum_num()
{
	sum = 0;
}
...
double Item_sum_sum_rcbase::val_real()
{
	...
	my_decimal2double(E_DEC_FATAL_ERROR, dec_buffs, &sum);
	return sum;
}
...
longlong Item_sum_sum_rcbase::val_int()
{
	...
	{
		longlong result;
		my_decimal2int(E_DEC_FATAL_ERROR, dec_buffs, unsigned_flag,
					   &result);
		return result;
	}
...
mysql_bool Item_sum_sum_rcbase::add(){ return false;}
...
//mysql_bool Item_sum_distinct_rcbase::add(){ return 0; }
...
//TODO: test this part
//__int64& Item_sum_hybrid_rcbase::int64_value()
_int64& Item_sum_hybrid_rcbase::int64_value()
{
	fixed = 1;
	return (_int64&)sum_int;
}
...
mysql_bool Item_sum_hybrid_rcbase::add(){ return false;}
