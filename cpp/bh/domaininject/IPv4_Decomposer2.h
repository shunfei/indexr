...
02111-1307 USA  */
#ifndef IPV4_2_H_INCLUDED
#define IPV4_2_H_INCLUDED

#include "DomainInjection.h"

class IPv4_Decomposer2 : public DomainInjectionDecomposer
{
public:
	...
	std::string GetRule() const { return "IPv4"; }

	static std::string GetName() { return "IPv4"; }
};
